  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Streamline Your Workforce with HR Management System - Centralizing Employee Data, Payroll, Time Tracking, Vacations and Performance Evaluations All in One Place."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Streamline Your Workforce with HR Management System - Centralizing Employee Data, Payroll, Time Tracking, Vacations and Performance Evaluations All in One Place.`}
            </Text>
            <Box
